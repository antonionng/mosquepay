  ...
  return (
    <div className="space-y-8">
      <div className="admin-page-head">
        <div>
          <h1 className="admin-page-title">Lodges</h1>
          <p className="admin-page-copy">
            Manage all lodges on the platform
          </p>
        </div>
        <Link
      ...
      {loading ? (
        <div className="admin-surface p-10 text-center text-slate-500">
          ...
          <p className="mt-3 text-sm">Loading lodges…</p>
        </div>
      ) : filtered.length === 0 ? (
                ...
                <tr key={lodge.id}>
                  <td>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white">{lodge.name}</p>
