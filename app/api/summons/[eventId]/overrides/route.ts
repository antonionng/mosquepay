...
export async function GET(request: NextRequest, { params }: Params) {
  ...
  const overrides = await db.listEventFeeOverrides(lodgeId, eventId);
...
export async function POST(request: NextRequest, { params }: Params) {
  ...
  const override = await db.upsertEventFeeOverride(lodgeId, {
    event_id: eventId,
...
export async function DELETE(request: NextRequest, { params }: Params) {
  ...
  await db.deleteEventFeeOverride(lodgeId, eventId, subjectType, subjectId);
