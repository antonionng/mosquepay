...
export async function POST(req: NextRequest) {
  ...
  const html = renderBrandedEmail({
    eyebrow: "Test Email",
    title: "MosquePay Email Configuration Test",
    preview: "This is a test email from MosquePay to verify email delivery.",
    children: `
      ...
      <p style="margin:18px 0 0;color:#64748b;font-size:16px;line-height:1.7;">
        Congratulations! Your MosquePay email configuration is working correctly.
      </p>
      ...
      <ul style="margin:12px 0 0;padding-left:22px;color:#111827;font-size:15px;line-height:1.7;">
        ...
        <li>The mosque-pay.com domain is verified</li>
        <li>Email branding and templates are rendering correctly</li>
        <li>The MosquePay logo is displaying properly</li>
      </ul>
      <p style="margin:18px 0 0;color:#64748b;font-size:16px;line-height:1.7;">
  ...
  try {
    const { data, error } = await resend.emails.send({
      from,
      to,
      subject: "MosquePay Test Email - Configuration Verified",
      html,
    });
