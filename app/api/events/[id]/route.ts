...
export async function PATCH(
  ...
  try {
    ...
    if (body.event_time != null) updates.event_time = body.event_time || null;
    ...
    if (body.meeting_fee_amount != null) updates.meeting_fee_amount = Number(body.meeting_fee_amount);
    ...
    if (body.guest_ticket_price != null) updates.guest_ticket_price = Number(body.guest_ticket_price);
