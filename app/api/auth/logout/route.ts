...
export async function POST() {
  ...
  // Clear the church cookie too so the next user who signs in on this device
  // doesn't inherit the previous admin's church selection. This is the most
  // common way ADMIN_CHURCH_COOKIE drifts away from the actor's actual church.
