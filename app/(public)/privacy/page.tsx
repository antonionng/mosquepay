...
export const metadata: Metadata = marketingMetadata({
  title: "Privacy Policy | ChurchPay",
  description:
    "How ChurchPay handles personal data across church websites, member portals, payments, communications, newcomer records, Gift Aid, pastoral notes, reporting, and administration tools.",
  path: "/privacy",
  keywords: ["ChurchPay privacy", "church software privacy", "church member data"],
});
...
const sections = [
  {
    ...
    body: [
      `This policy explains how ${PRODUCT_NAME} handles personal data when people visit our website, contact us, request a demo, use a church website powered by ${PRODUCT_NAME}, or access the member and admin platform.`,
      `For church records, member data, newcomer details, pastoral notes, payments, service notices, communications, and reports, the relevant church, network, or platform customer is usually the data controller. ${COMPANY_NAME} acts as a data processor where we host and operate ${PRODUCT_NAME} on their behalf.`,
    ],
  },
  {
...
export default function PrivacyPage() {
  return (
    <LegalPage
      kicker="Privacy"
      title="Privacy Policy for the ChurchPay platform."
      intro={`Last updated ${LEGAL_LAST_UPDATED}. This page explains how personal data is handled across ChurchPay websites, member portals, payments, communications, and church administration tools under UK data protection law.`}
      sections={sections}
      footer={
        <>
