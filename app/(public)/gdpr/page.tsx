...
export const metadata: Metadata = marketingMetadata({
  title: "GDPR and Data Protection | MosquePay",
  description:
    "GDPR information for MosquePay customers, mosques, networks, members, newcomers, donors, and platform users. Covers controller roles, processor duties, member records, newcomer data, Gift Aid, payments, pastoral notes, and security.",
  path: "/gdpr",
  keywords: ["MosquePay GDPR", "mosque software GDPR", "mosque data protection"],
});
...
const sections = [
  {
    ...
    body: [
      "For most mosque records, the mosque, network, or platform customer decides why and how personal data is used. That organisation is usually the data controller.",
  ...
  },
  {
    ...
    body: [
      ...
      "Some customers may use the welfare, compliance, or mentoring modules to store special category or sensitive personal data. These modules should be used only where there is a lawful basis and suitable internal governance.",
    ],
  },
  {
    title: "Lawful basis",
    body: [
      ...
      "MosquePay processes customer data under customer instructions, our service terms, data protection obligations, and the operational need to deliver and protect the platform.",
    ],
  },
  {
    ...
    body: [
      ...
      "Where a request relates to customer-controlled mosque records, MosquePay may need to route the request to the relevant customer. We will support customers with reasonable technical assistance where needed.",
    ],
  },
  {
    title: "Security and tenant separation",
    body: [
      "The platform is designed around tenant separation, mosque context, role-based permissions, audit trails, secure session handling, encrypted transport, and restricted administrative access.",
  ...
  },
  {
    ...
    body: [
      "MosquePay may use subprocessors for hosting, database services, storage, email delivery, observability, payments, analytics, support operations, backups, and security.",
...
export default function GDPRPage() {
  return (
    <LegalPage
      kicker="GDPR"
      title="GDPR information for MosquePay customers and users."
      intro={`Last updated ${LEGAL_LAST_UPDATED}. This page explains how ${PRODUCT_NAME} is intended to support data protection duties across mosque operations, public websites, member portals, payments, communications, and sensitive team workflows.`}
      sections={sections}
      footer={
        <>
