...
export function PersonPickerSheet({
  ...
  // huge on busy lodges and we don't want to ship the whole thing to every
  ...
  const [draft, setDraft] = useState<GuestInlineDraft>({
    ...
    email: null,
    phone: null,
    mother_lodge_name: null,
    mother_lodge_number: null,
  });
    ...
    try {
      const res = await fetch("/api/admin/take-payment/guests", {
        ...
        body: JSON.stringify({
          ...
          mother_lodge_name: draft.mother_lodge_name ?? undefined,
          mother_lodge_number: draft.mother_lodge_number ?? undefined,
        }),
      });
        ...
        {view === "list" ? (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-emerald-700/80">
                        Capture name, email, and mother lodge for the receipt.
                      </p>
                    </div>
                  </button>
                </li>
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            <div className="space-y-3">
              ...
              <Field
                label="Mother lodge"
                value={draft.mother_lodge_name ?? ""}
                onChange={(v) =>
                  setDraft({
                    ...draft,
                    mother_lodge_name: v.trim() ? v : null,
                  })
                }
                placeholder="Optional"
                autoCapitalize="words"
              ...
              <Field
                label="Lodge number"
                value={draft.mother_lodge_number ?? ""}
                onChange={(v) =>
                  setDraft({
                    ...draft,
                    mother_lodge_number: v.trim() ? v : null,
                  })
                }
                placeholder="Optional"
              />
