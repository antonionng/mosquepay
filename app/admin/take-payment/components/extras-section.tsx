...
// Collapsible "extras" panel: category, reference, and a receipt note.
// Hidden by default to keep the entry form to the essentials — most
...
export function ExtrasSection({
  ...
  const filled =
    category !== "general" || reference || description || note;
