 ...
 * attach a cash/QR payment to a meeting after the fact when the duty
 ...
 * active lodge.
 */
export function AttachToMeetingCard({
  paymentId,
  currentEventId,
  events,
}: {
  ...
  return (
    <div className="space-y-3">
      <Label htmlFor="attach-event">Attach to meeting</Label>
      ...
      <p className="text-xs text-dash-text-muted">
        Linking a cash or QR payment to a meeting rolls it into the
        meeting&apos;s &quot;Money raised&quot; total.
      </p>
      {error ? (
