...
} from "@/lib/giving/status-display";
import type { GivingSchedule, GivingScheduleStatus } from "@/lib/db/types";
...
interface Props {
  initialSchedules: GivingSchedule[];
  counts: Record<GivingScheduleStatus, number>;
  memberLookup: Record<string, MemberLookupEntry>;
}

const FILTER_TABS: Array<{
  id: "all" | "needs_attention" | GivingScheduleStatus;
  label: string;
}> = [
  { id: "all", label: "All" },
...
const NEEDS_ATTENTION_STATUSES: GivingScheduleStatus[] = [
  "action_required",
  "past_due",
  "paused",
];

export function GivingSchedulesClient({
  initialSchedules,
  counts,
  memberLookup,
}: Props) {
