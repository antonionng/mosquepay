...
const schema = z.object({
  ...
  mother_mosque_name: z.string().optional(),
...
export function NewcomerRegisterForm({ mosqueSlug }: Props) {
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      const res = await fetch(
        `/api/newcomers/mosque/${encodeURIComponent(mosqueSlug)}/register`,
        {
          method: "POST",
