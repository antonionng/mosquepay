// Surfaces Mooov's typed `merchant_not_charge_capable` 422 to the lodge admin:
...
// payment_attempts.metadata.merchant_setup by app/api/dues/start; the latest
...
export function MooovSetupRequiredBanner({ hint }: { hint: MooovSetupHint }) {
  ...
  const bodyMessage =
    hint.message ??
    "We tried to charge through this lodge's Mooov merchant, but the merchant has not finished connecting a payment provider yet.";
