...
export function LodgeFeeDefaultsSettings() {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        setMessage({ type: "success", text: "Meeting and dining fee defaults saved." });
      } else {
        ...
        <CardContent className="border-t border-dash-border bg-dash-surface p-5 md:p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            <div className="space-y-2">
              <Label htmlFor="memberLevy">Member meeting levy (£)</Label>
              ...
              <p className="text-xs text-dash-muted">Charged when attending the meeting.</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-xs text-dash-muted">Leave blank to set per meeting only.</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-xs text-dash-muted">Per registered guest at the festive board.</p>
            </div>
          </div>
