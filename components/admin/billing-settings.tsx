...
const FEATURE_LABELS: Record<string, string> = {
  ...
  multi_lodge: "Multiple lodges",
  cross_lodge_reporting: "Cross-lodge reporting",
  central_billing: "Central billing",
  province_dashboards: "Provincial dashboards",
  migration_planning: "Migration planning",
  named_support: "Named provincial contact",
  ai: "AI-assisted drafting",
  integrations: "Integrations",
  mentor: "Mentor and progression",
};
