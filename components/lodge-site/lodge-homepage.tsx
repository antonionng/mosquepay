...
function AboutSection({ section }: { section: SiteSection }) {
  return (
    <section className="py-20 lg:py-28 bg-white" aria-label="About">
...
function MeetingDetailsSection({
  ...
  return (
    <section className="py-20 lg:py-28 border-y border-slate-200 bg-slate-50" aria-label="Meeting details">
      <div className="container-full">
        <FadeIn>
...
function OfficersSection({ section }: { section: SiteSection }) {
  return (
    <section className="py-20 lg:py-28 bg-white" aria-label="Officers">
      <div className="container-full">
        <FadeIn>
          <div className="mb-14 max-w-2xl">
...
function CharitySection({
  ...
  return (
    <section className="py-20 lg:py-28 border-y border-slate-200 bg-slate-50" aria-label="Charity">
      <div className="container-full">
...
function EventsSection({
  ...
  return (
    <section className="py-20 lg:py-28 bg-white" aria-label="Events">
      <div className="container-full">
        <FadeIn>
          <div className="mb-14 max-w-2xl">
...
function ContactSection({
  ...
  return (
    <section className="py-20 lg:py-28 border-t border-slate-200 bg-white" aria-label="Contact">
      <div className="container-full">
            ...
            <div>
              ...
              <form className="mt-10 space-y-5" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="contact-message"
                    placeholder="Tell us about your interest in the lodge..."
                    rows={5}
                  />
                </div>
...
function GenericSection({ section }: { section: SiteSection }) {
  return (
    <section className="py-20 lg:py-28 bg-white" aria-label={section.heading}>
      <div className="container-full">
        <FadeIn>
...
function SectionRenderer({
  ...
  switch (section.type) {
    case "hero":
      return <HeroSection section={section} lodge={lodge} lodgeSlug={lodgeSlug} />;
    case "about":
      return <AboutSection section={section} />;
    case "meeting_details":
      return <MeetingDetailsSection section={section} lodgeSlug={lodgeSlug} />;
    case "officers":
      return <OfficersSection section={section} />;
    case "charity":
      return <CharitySection section={section} lodgeSlug={lodgeSlug} />;
    case "events":
      return <EventsSection section={section} lodgeSlug={lodgeSlug} />;
    case "faq":
      return <FaqSection section={section} />;
    case "join":
      return <JoinSection section={section} lodgeSlug={lodgeSlug} />;
    case "contact":
      return <ContactSection section={section} lodge={lodge} />;
    default:
