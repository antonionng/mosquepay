...
type TemplatePreset = {
  ...
  tags?: string[];
  bestFor?: string;
  buildSections: () => MosqueSiteSection[];
};
...
export type SectionVariantPreset = {
  id: string;
  type: MosqueSiteSection["type"];
  label: string;
  description: string;
  tone: "classic" | "modern" | "conversion" | "community";
  tags: string[];
  example: () => MosqueSiteSection;
};
...
const TEMPLATE_IMAGES = {
  heritageHero: {
    ...
    alt: "Mosque members in a traditional mosque room",
  },
  mosqueWelcome: {
    src: "/site-template-images/newcomersor-contact.png",
    alt: "Mosque members welcoming newcomers",
  },
  mosqueService: {
    src: "/site-template-images/officers-formal.png",
    alt: "Formal mosque service with officers",
  },
  newcomerConversation: {
    src: "/site-template-images/newcomer-conversation.png",
    alt: "Mosque members discussing newcomer enquiries",
  },
  networkNewcomerership: {
    src: "/site-template-images/network-newcomerership.png",
    alt: "Mosque officers in formal dress",
  },
  charityGiving: {
    src: "/site-template-images/charity-pastoral.png",
    alt: "Mosque members supporting charity and pastoral work",
  },
  officersFormal: {
    src: "/site-template-images/officers-formal.png",
    alt: "Formal mosque officers in the mosque room",
  },
  charityPastoralCare: {
    src: "/site-template-images/charity-pastoral.png",
    alt: "Mosque members discussing charity and pastoral support",
  },
  newcomerContact: {
    src: "/site-template-images/newcomersor-contact.png",
    alt: "Mosque members welcoming newcomers",
...
): NonNullable<MosqueSiteSection["style"]> {
  return {
...
function imageStyle(
  image: TemplateImage,
  imagePosition: NonNullable<NonNullable<MosqueSiteSection["style"]>["image_position"]> = "right",
  imageShape: NonNullable<NonNullable<MosqueSiteSection["style"]>["image_shape"]> = "rounded"
): NonNullable<MosqueSiteSection["style"]> {
  return {
    image_url: image.src,
    image_alt: image.alt,
...
function styleWith(
  style: NonNullable<MosqueSiteSection["style"]>,
  overrides: NonNullable<MosqueSiteSection["style"]>
): NonNullable<MosqueSiteSection["style"]> {
...
function s(
  ...
  ctaHref: string | null,
  order: number,
  style: MosqueSiteSection["style"] = null
): MosqueSiteSection {
  return {
    id: id(),
    type,
...
function packFooter(
  ...
  return {
    ...
    tagline,
    badge_text: "Official mosque website",
...
function buildCorePages(kind: TemplatePreset["category"] = "heritage"): MosqueSiteCustomPage[] {
  ...
  return [
    page(
      "about",
      "About the mosque",
      "Learn about the mosque, its values, service rhythm, charity, and welcome for newcomers.",
      1,
      [
        s(
          "hero",
          "About our mosque",
          "A public introduction to our history, community, charitable work, and place in the community.",
        "Plan a visit",
        "/events",
          1,
        ...
        s(
          ...
          "Use this page to tell newcomers what makes the mosque distinctive: its history, character, members, and charitable aims.",
          null,
          null,
          2,
        ...
        s(
          ...
          "Explain when the mosque meets, who to contact before newcomer, dress expectations, dining, and venue details.",
          "View events",
          "/events",
          3,
          imageStyle(TEMPLATE_IMAGES.mosqueService, "left", "rounded")
        ),
      ]
    ),
    page(
      "join",
      "Join or visit",
      "A friendly page for prospective members to learn more and submit an enquiry to the mosque pipeline.",
      2,
      [
        s(
          "hero",
          "Could mosque life be for you?",
          "If you are curious about newcomer or joining, start a conversation with the mosque.",
          "Start an enquiry",
          "#newcomer-intake",
          1,
        ...
        s(
          ...
          "Tell us a little about yourself and the mosque team will follow up personally.",
          "Express interest",
          "#newcomer-intake",
          3,
          {
            form_mode: "newcomer",
            image_url: TEMPLATE_IMAGES.mosqueWelcome.src,
            image_alt: TEMPLATE_IMAGES.mosqueWelcome.alt,
            image_position: "right",
            image_shape: "rounded",
            background_tone: "brand",
            form_fields: ["phone", "location", "how_heard", "message", "consent"],
            form_required_fields: ["consent"],
            form_consent_text: "I agree to be contacted by the mosque about my membership enquiry.",
            form_thank_you: "Thanks. Your enquiry has been added to the mosque pipeline.",
          }
        ),
      ],
      "Join"
    ...
    page(
      "contact",
      "Contact the mosque",
      "Send a message to the mosque admin team about newcomer, joining, dining, charity, or general enquiries.",
      3,
      [
        s(
          "hero",
          "Contact the mosque",
          "Reach the secretary and mosque admin team for newcomer, joining, dining, or general questions.",
          "Send a message",
          "#contact-form",
          1,
        ...
        s(
          "contact",
          "Send a message",
          "Your message will go to the active mosque admins and configured mosque contact email.",
          ...
          2,
          {
            ...
            form_consent_text: "I agree to be contacted by the mosque about my enquiry.",
            form_thank_you: "Thanks. Your message has been sent to the mosque admin team.",
          }
        ),
      ],
      "Contact"
    ...
    page(
      ...
      "Show the mosque's charitable work, community support, campaigns, and fundraising activity.",
      4,
      [
        s(
          "hero",
          "Charity and community",
          "Our charitable work connects mosque values with practical support for good causes.",
          "Support our work",
          "/site/charity",
          1,
...
export const SECTION_PRESETS: Array<{
...
}> = [
  {
    ...
    example: () =>
      s(
        "hero",
        "Welcome to your mosque",
        "A modern memberhood with deep heritage. Discover services, charity, and community.",
        "Express interest",
        "/site/join",
        1
      ),
  },
  {
    type: "about",
    label: "About",
    description: "Short paragraph about the mosque identity and values.",
    example: () =>
      s(
        "about",
        "About the mosque",
        "Founded in community and service, we welcome members from all backgrounds.",
        null,
        null,
        2
      ),
  },
  {
    ...
    label: "Service times",
    description: "Where and when the mosque meets.",
    example: () =>
      s(
        "service_details",
        "When we meet",
  ...
  },
  {
    ...
    example: () =>
      s(
        ...
        "Our officers serve the mosque and represent our values throughout the year.",
        null,
        null,
        4
      ),
...
export const SECTION_VARIANTS: SectionVariantPreset[] = [
  {
    ...
    example: () =>
      s(
        "hero",
        "A mosque with history, community, and purpose",
        "Discover services, charity, and community in a mosque rooted in tradition and open to good men of character.",
        "Contact the secretary",
        "#contact-form",
        1,
  ...
  },
  {
    ...
    description: "A direct newcomer intake section for mosques focused on growth.",
    tone: "conversion",
    ...
    example: () =>
      s(
        "hero",
        "Could mosque life be for you?",
        "If you are curious about newcomer or joining, start a conversation with our mosque today.",
        "Start enquiry",
        "#newcomer-intake",
        1,
  ...
  },
  {
    ...
    description: "A polished about section for history, values, and mosque identity.",
    tone: "classic",
    tags: ["Story", "Values"],
    example: () =>
      s(
        "about",
        "Our story",
        "Founded in community and service, our mosque brings members together through ritual, charity, and lasting friendship.",
        "Learn more",
        "/about",
        2,
  ...
  },
  {
    ...
    example: () =>
      s(
        "officers",
        "This year's officers",
        "Meet the members serving the mosque this year and learn how each office supports our services, newcomers, charity, and community.",
        null,
        null,
        4
      ),
  },
  {
    ...
    example: () =>
      s(
        "charity",
        "Charity in action",
        "Share the causes your mosque supports, the impact already made, and how newcomers or members can contribute.",
        "Support our charity",
        "/site/charity",
        5,
  ...
  },
  {
    ...
    example: () =>
      s(
        ...
        "Practical answers about joining, newcomer, dress code, costs, and what happens at a mosque service.",
        null,
        null,
        7
      ),
  },
  {
    ...
    description: "A complete enquiry block that creates a CRM newcomer for the mosque pipeline.",
    tone: "conversion",
    ...
    example: () =>
      s(
        "join",
        "Start a membership conversation",
        "Tell us a little about yourself and the mosque team will be in touch.",
        "Open enquiry form",
        "#newcomer-intake",
        8,
        {
  ...
  },
  {
    ...
    type: "contact",
    label: "Mosque admin contact form",
    description: "A contact block routed to active mosque admins and the mosque support email.",
    tone: "classic",
    tags: ["Secretary", "Email notification"],
    example: () =>
      s(
        "contact",
        "Contact the mosque secretary",
        "For newcomer, joining, dining, or general questions, send a message directly to the mosque admin team.",
        "Send message",
        "#contact-form",
        9,
        {
...
export const TEMPLATES: TemplatePreset[] = [
  {
    ...
    description: "A polished mosque homepage with a grand hero, clear newcomer path, charity story, and contact form.",
    category: "heritage",
    accent: "#1e3a8a",
    tags: ["Heritage", "Balanced", "Newcomer friendly"],
    bestFor: "Mosques that want a dignified public site with minimal editing.",
    buildSections: () => [
      s(
        "hero",
        "Welcome to our mosque",
        "A warm public welcome rooted in community, service, and a tradition that still matters today.",
        "Express interest",
        "/site/join",
        1,
      ...
      s(
        ...
        "Introduce your mosque with a short story about who you are, where you meet, and why newcomers and newcomers receive a warm welcome.",
        null,
        null,
        2,
      ...
      s(
        "contact",
        "Speak with our team",
        "Route every newcomer enquiry straight to the mosque team, with a simple form that feels approachable.",
        "Contact us",
        "/site/contact",
        5,
        {
  ...
  },
  {
    ...
    description: "A clean contemporary site for mosques that want newcomers and prospective members to take action.",
    category: "growth",
    accent: "#0f766e",
    tags: ["Modern", "Recruitment", "Events"],
    bestFor: "Mosques that want a modern public presence and more suitable enquiries.",
    buildSections: () => [
      s(
        "hero",
        "A modern mosque with deep roots",
        "Community, charity, and personal growth presented in a clear journey for today's newcomers.",
        "Get in touch",
        "/site/contact",
        1,
        heroStyle(TEMPLATE_IMAGES.mosqueWelcome, 0.48, "center")
      ),
      s(
        "about",
        "Who we are",
        "Explain the mosque in plain English: who you welcome, what services are like, and what makes the atmosphere special.",
        null,
        null,
        2,
      ...
      s(
        ...
        "/events",
        3,
        imageStyle(TEMPLATE_IMAGES.mosqueService, "right", "rounded")
      ),
      s(
        "officers",
        "Our officers",
        "Put friendly faces behind the mosque by showing the officers and their responsibilities.",
        null,
        null,
        4,
      ...
      s(
        "join",
        "Express interest",
        "Make the next step simple: a short enquiry form creates a newcomer and alerts the right mosque team.",
  ...
  },
  {
    ...
    description: "A high-impact site for mosques that want their community work and campaigns to newcomer the story.",
    category: "charity",
    accent: "#be123c",
    tags: ["Charity", "Community", "Campaigns"],
    bestFor: "Mosques with active fundraising, visible community work, or a major appeal.",
    buildSections: () => [
      s(
        "hero",
        "Service before self",
        "A bold homepage for showing the good your mosque does, the causes you support, and how people can help.",
        "Support our work",
        "/site/charity",
        1,
      ...
      s(
        "about",
        "Why we do this",
        "Connect the campaign back to mosque values so newcomers understand that charity is part of the culture, not an add-on.",
        null,
        null,
        3,
      ...
      s(
        "contact",
        "Get in touch",
        "Let donors, newcomers, and local partners contact the mosque team directly from the page.",
        "Contact us",
        "/site/contact",
        5,
        {
  ...
  },
  {
    ...
    description:
      "Deep dive into your mosque's story: founding, notable members, banner, and ritual heritage.",
    category: "heritage",
    accent: "#92400e",
    tags: ["History", "Past Masters", "Newcomers"],
    bestFor: "Older mosques with a strong story to tell.",
    buildSections: () => [
      s(
        "hero",
        "A heritage worth honouring",
        "Founded in community, sustained by service, our mosque has been a part of this community for generations.",
        "Our story",
        "#about",
        1,
      ...
      s(
        "about",
        "Our founding",
        "Established under the United Grand Mosque of England, we trace our origins to members committed to friendship, morality and memberly love.",
        null,
        null,
        2,
      ...
      s(
        ...
        "Past Masters and benefactors who shaped our mosque. Use this space to celebrate them.",
        null,
        null,
        3,
      ...
      s(
        "officers",
        "Past Masters",
        "An unbroken chain of newcomerership stretching back to establishment.",
        null,
        null,
        4,
  ...
  },
  {
    ...
    bestFor: "Mosques that want to showcase newcomerership and service rhythm.",
    buildSections: () => [
      s(
        "hero",
        "This year's team",
        "Meet the officers of the mosque for the current Giving year.",
        "Meet the team",
        "#officers",
        1,
      ...
      s(
        "officers",
        "Officers of the mosque",
        "Each office serves a specific role in the work of the mosque. The list below is kept up-to-date automatically from our register.",
        null,
        null,
        2,
        imageStyle(TEMPLATE_IMAGES.networkNewcomerership, "right", "rounded")
      ...
      s(
        "service_details",
        "When we meet",
        "Regular services, mosque of instruction, and rehearsal dates.",
        "View calendar",
        "/events",
        3,
        imageStyle(TEMPLATE_IMAGES.mosqueService, "left", "rounded")
      ...
      s(
        ...
        "/events",
        4,
        imageStyle(TEMPLATE_IMAGES.mosqueWelcome, "right", "rounded")
      ),
      s(
        "contact",
  ...
  },
  {
    ...
    buildSections: () => [
      ...
      s(
        "about",
        "Why we give",
        "Charity is at the heart of mosque life. This campaign continues a centuries-old tradition.",
        null,
        null,
        3,
        imageStyle(TEMPLATE_IMAGES.newcomerConversation, "left", "rounded")
  ...
  },
  {
    ...
    name: "Simple launch",
    description:
      "A quick, elegant site for mosques that need a beautiful live page without much editing.",
    category: "operations",
    accent: "#0369a1",
    tags: ["Simple", "Contact", "Venue"],
    bestFor: "Mosques that want to launch today and refine later.",
    buildSections: () => [
      s(
        "hero",
      ...
      s(
        "contact",
        "Get in touch",
        "Send a message to the mosque team about newcomer, joining, dining, or general enquiries.",
        "Email the secretary",
        "/site/contact",
        2,
        {
  ...
  },
  {
    ...
    description: "Designed to guide curious newcomers from first question to a warm mosque conversation.",
    category: "growth",
    accent: "#7c3aed",
    tags: ["Newcomer intake", "FAQ", "Growth"],
    bestFor: "Mosques that want more suitable newcomer enquiries without overwhelming newcomers.",
    buildSections: () => [
      s(
        "hero",
        "Could mosque life be for you?",
      ...
      s(
        "about",
        "What it means to be a mosque member",
      ...
      s(
        "faq",
        "Common questions",
        "Answer the practical questions most people have before they speak to a mosque.",
        null,
        null,
        3,
        {
      ...
      s(
        "join",
        "Take the next step",
        "A short form routes the newcomer into the mosque pipeline and alerts the right team.",
        "Express interest",
        "/site/join",
        5,
        {
